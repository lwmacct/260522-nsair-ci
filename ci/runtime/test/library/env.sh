...
_container_security_policy_base_image="${NSCELL_CI_CONTAINER_SECURITY_POLICY_BASE_IMAGE:-docker.io/library/python:3.12-alpine}"
...
_procfs_cpu_base_image="${NSCELL_CI_PROCFS_CPU_BASE_IMAGE:-docker.io/library/python:3.12-alpine}"
