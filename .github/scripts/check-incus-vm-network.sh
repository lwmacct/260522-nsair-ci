...
_vm_name="${NSCELL_VM_NAME:?NSCELL_VM_NAME is required}"
_network_interface="${NSCELL_VM_NETWORK_INTERFACE:-enp5s0}"
_log_dir="${NSCELL_VM_LOG_DIR:-${RUNNER_TEMP:-/tmp}/nscell-vm-network-logs}"
